  ...
  return (
    <Tilt className="xs:w-[250px] w-full">
      ...
      className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card">
        <div options={{max: 45,
        scale: 1,
        speed: 450}} classname="bg-tertiary rounded-[20px]
  ...
  return (
    <>
      ...
      text-secondary text-[17px] max-w-3xl leading-[30px]">
        I'm a skilled software engineer with experience in Java, Python,
        JavaScript, TypeScript and expertise in frameworks like React and Node.js.
